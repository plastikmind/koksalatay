        ...
        <div className="grid items-start grid-cols-1 md:grid-cols-3 ">
          ...
          <div className="sticky flex flex-col items-center justify-center top-0 px-5 bg-[#e0e2ee] min-h-screen pb-10 sm:pb-0">
            <div className="flex flex-col pt-10 sm:pt-0">
              <p className="text-4xl lg:text-5xl xl:text-6xl font-extrabold uppercase">
                {name}
              </p>
                ...
                <div className="flex flex-col w-full">
                  ...
                  <div className="flex justify-between w-full py-5">
                    <p className="text-center">
                      Size
                      <br />
                      <span className="italic font-bold">{size}</span>
                    </p>
                    <p className="text-center">
                      Color <br />
                      <span className="italic font-bold">{color}</span>
                    </p>
                    <p className="text-center">
                      Fabric <br />
                      <span className="italic font-bold">{fabric}</span>
                    </p>
                  </div>
                  <div className="flex justify-between w-full py-5">
                    <p className="text-center">
                      Shoulder
                      <br />
                      <span className="italic font-bold">{shoulder}</span>
                    </p>
                    <p className="text-center">
                      Sleeve <br />
                      <span className="italic font-bold">{sleeve}</span>
                    </p>
                    <p className="text-center">
                      Length <br />
                      <span className="italic font-bold">{length}</span>
                    </p>
                  </div>
